...
saveRDS(result_model, paste0("result/result_model_inteli_nmda_",today(),".rds"))
...
source("R/batch/batch_predict.R")
saveRDS(temp_predict_animalxmodel, 
        paste0("result/result_predict_animalxmodel_inteli_nmda_",today(),".rds"))

source("R/batch/batch_predict_probability.R")
saveRDS(temp_prediction_choicexmodel, 
        paste0("result/result_predict_choicexmodel_inteli_nmda_",today(),".rds"))