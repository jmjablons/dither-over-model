...
saveRDS(result_model, paste0("result/result_model_inteli_reward_",today(),".rds"))
saveRDS(temp_predict_animalxmodel, paste0("result/result_predict_inteli_reward_",today(),".rds"))
